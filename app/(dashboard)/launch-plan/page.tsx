  ...
  return (
    <div style={{ padding: '32px 32px 80px', maxWidth: 1320, margin: '0 auto', fontFamily: F.body, color: C.text }}>
      ...
      <div style={{ background: C.bg2, border: `1px solid ${C.border}`, borderRadius: 14, padding: '26px 30px', marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 14, color: '#FFFFFF', lineHeight: 1.65, padding: '16px 20px', background: 'rgba(46,117,182,0.10)', border: '1px solid rgba(46,117,182,0.30)', borderRadius: 10, fontWeight: 400 }}>
          <strong style={{ color: C.gold }}>Why this works:</strong> Wagner has $25M+ existing EBITDA. At 3× senior leverage, that supports <strong style={{ color: C.gold }}>$75M+ debt capacity</strong> — comfortably above the <strong style={{ color: C.globe }}>{fmtMoney(totalBankDebt)}</strong> needed over 24 months. Wagner can also choose <strong style={{ color: C.gold }}>all-cash on individual deals</strong> from practice cash flow when rate environment or deal economics favor it. Each acquired clinic generates <strong style={{ color: C.green }}>+$250K-$500K EBITDA</strong>{' '}in year 1 (Wagner&apos;s medical-team install), which covers debt service with cushion. By month 24, acquired-clinic cash flow alone services the debt — Wagner&apos;s existing $25M+ is locked into the platform for the exit re-rate, not at risk for operating coverage.
        </div>
      </div>
