    ...
    <div style={{ padding: '32px 32px 80px', maxWidth: 1320, margin: '0 auto', fontFamily: F.body, color: C.text }}>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 15, color: C.muted, margin: 0, maxWidth: 880, lineHeight: 1.55 }}>
          Wagner writes <strong style={{ color: C.gold }}>{fmtMoney(monthlyBurnY1 * 12)}</strong> over the first 12 months for operating capital (team + ads + SaaS) — drawn monthly. <strong style={{ color: C.green }}>Y2 is self-funding</strong> from clinic cash flow + Scale Services revenue. Acquisitions paid via <strong style={{ color: C.gold }}>bank debt or cash</strong> — both backed by Wagner&apos;s existing $25M+ EBITDA. <strong style={{ color: C.text }}>Wagner owns 100% of each clinic the moment the seller chiropractor signs.</strong> KB earns 4% one-time consulting fee on deals sourced on platform + 5% ongoing rev share + 5% exit fee. <strong style={{ color: C.gold }}>All multiple arbitrage on exit goes to Wagner.</strong>
        </p>
      </div>
