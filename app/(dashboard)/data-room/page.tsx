...
const DOCS: Doc[] = [
  {
    ...
    paragraph: 'How ProMed VA turns a chiropractor\'s overlooked goodwill into a quarter-million-a-year partnership and, eventually, a real exit. The goodwill trap, the two-phase model (Phase 1 lease ~$200K/yr rent + cash-service commission; Phase 2 acquire at 50% cash / 50% seller note + 4% profit share at a platform multiple), why Virginia first, and the lean Kingdom-Broker-managed two-city test.',
    category: 'thesis',
    accent: '#C9A84C',
  ...
  },
  {
    ...
    oneLiner: 'What to wire Kingdom Broker LLC to run the test — and the terms.',
    paragraph: 'The lean two-city test budget: ~$5K platform/funnels (already built), video, $5K/mo ads, lists/tooling, the team Eric hires, and a $3K/mo Kingdom Broker management fee (cancel anytime, 14-day notice). ~$19K month 1, ~$11-12K/mo after. Plus the proposed success fee on chiropractors we bring in and the fair engagement terms so nobody works for free.',
    category: 'brand',
    accent: '#2ECC8B',
