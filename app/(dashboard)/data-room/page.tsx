...
const DOCS: Doc[] = [
  ...
  },
  {
    ...
    paragraph: 'The lean two-city test budget — a one-time $8K setup (platform/funnels already built + video) folded into month 1, then $5K/mo ads, lists/tooling, the team Eric hires, and a $3K/mo Kingdom Broker management fee. $19K month 1, then $11K/mo total. Plus the proposed success fee on chiropractors we bring in — 4% of acquisition value + 2% revenue share on the chiro office — and the engagement terms.',
    category: 'brand',
    accent: '#2ECC8B',
