...
const MOCK: OverviewData = {
  ...
  states:          1,
  topDeals: [
    { name: 'Valley Spine & Wellness',        city: 'Harrisonburg', state: 'VA', status: 'Discovery booked', valuation: 1_450_000, npm: 64, daysIn: 6 },
    { name: 'Blue Ridge Family Chiropractic', city: 'Waynesboro',   state: 'VA', status: 'Qualified',        valuation: 1_200_000, npm: 44, daysIn: 3 },
    { name: 'James River Spine Center',       city: 'Lynchburg',    state: 'VA', status: 'Discovery booked', valuation: 1_350_000, npm: 52, daysIn: 5 },
    { name: 'Staunton Chiropractic & Rehab',  city: 'Staunton',     state: 'VA', status: 'Qualified',        valuation: 1_150_000, npm: 38, daysIn: 4 },
    { name: 'Capital City Spine & Sport',     city: 'Richmond',     state: 'VA', status: 'Applied',          valuation: 1_250_000, npm: 41, daysIn: 2 },
  ],
  activity: [
    { kind: 'apply',     text: 'Valley Spine & Wellness (Harrisonburg) submitted intake — qualified',           ago: '4h',  tone: '#2ECC8B' },
    { kind: 'call',      text: 'McGrath booked discovery call with James River Spine Center (Lynchburg) — Thursday', ago: '7h',  tone: '#2E75B6' },
    { kind: 'qualified', text: 'Blue Ridge Family Chiropractic (Waynesboro) moved to Qualified',                ago: '11h', tone: '#9CC4E4' },
    { kind: 'note',      text: 'Strategy: smaller college towns first — one strong partner per town, then Richmond.', ago: '18h', tone: '#C9A84C' },
    { kind: 'apply',     text: 'Capital City Spine & Sport (Richmond) submitted intake — qualified',            ago: '1d',  tone: '#2ECC8B' },
    { kind: 'apply',     text: '5 new applications this week · Harrisonburg + Lynchburg + Staunton',            ago: '2d',  tone: '#2ECC8B' },
  ],
  ...
  alerts: [
    { level: 'urgent', text: 'Valley Spine & Wellness (Harrisonburg) · discovery call booked — principal to join' },
    { level: 'watch',  text: 'James River Spine (Lynchburg) · 11h since last contact · McGrath to follow up' },
    { level: 'watch',  text: 'Harrisonburg ad set learning-phase · cost-per-app still settling' },
    { level: 'ok',     text: 'Blue Ridge + Staunton both clear the 25+/mo new-patient floor' },
    { level: 'ok',     text: 'Value My Clinic tool live · driving top-of-funnel in the focus cities' },
  ],
    ...
    <div style={{ padding: '32px 32px 80px', maxWidth: 1320, margin: '0 auto', fontFamily: F.body, color: C.text }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18, marginBottom: 24 }} className="kb-overview-grid">
        <div style={{ background: `linear-gradient(135deg, rgba(201,168,76,0.10), ${C.bg2})`, border: `1px solid rgba(201,168,76,0.30)`, borderLeft: `4px solid ${C.gold}`, borderRadius: 14, padding: '24px 28px' }}>
          ...
          <p style={{ fontSize: 14.5, color: '#FFFFFF', lineHeight: 1.6, margin: 0, opacity: 0.9 }}>PROMEDVA leases space inside the clinic for a medical office — <strong style={{ color: C.gold }}>$10K/mo base lease + quarterly performance bonuses (~$25K, on hitting the metrics) → ~$200K/yr to the practice</strong> (up to ~$250K as the cash-pay medical-services line ramps). Our medical team runs the diagnostics; they keep practicing exactly as they do. Low-risk — the easy yes.</p>
        </div>
