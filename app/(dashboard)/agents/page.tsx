...
export default function AgentCenterPage() {
  return (
    <ComingSoon
      ...
      description="PROMEDVA's autonomous discovery + outreach pipeline. Twelve specialized agents run continuously: six discover seller-side chiropractor targets matching Wagner's buy-box; six enrich + score + write personalized outreach. Wagner sees a live engine room, not a black box."
      eta="Phase 3 · 2026-Q4"
      bullets={[
        ...
        { title: '6 Buyer/operator agents', desc: 'Family-office + PE search agents matching PROMEDVA\'s buy-box. Each lead scored on fit, pitch drafted automatically, status logged.' },
