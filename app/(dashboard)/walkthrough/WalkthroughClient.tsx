...
const STEPS = [
  ...
  },
  {
    ...
    what: 'Every chiropractor who has filled out the /intake form lands here as a row. Wagner\'s 7 qualification metrics are auto-scored on submit — qualified, maybe, or not yet — and an instant valuation band is calculated from 100+ chiropractic practice sales.',
    features: [
      ...
      { title: 'Valuation band stored', desc: 'Each submission saves valuation_low / valuation_mid / valuation_high — calibrated to 100+ chiropractic practice sales (median 1.46× SDE).' },
  ...
  },
  {
    ...
    what: 'Drag the sliders, pick the Practice Profile (Solo / Multi / Platform), watch the platform re-rate in real time. Every multiple is calibrated to 100+ chiropractic practice sales — not industry article guesses.',
    features: [
  ...
  },
  {
    ...
    what: 'Drop in 3 years of P&L + tax returns + bank statements. Claude extracts revenue, owner comp, normalizes EBITDA, identifies add-backs — then prices the practice against 100+ chiropractic practice sales.',
    features: [
      ...
      { title: 'Comp-based valuation band', desc: 'Returns low/mid/high range calibrated to 100+ chiropractic practice sales. Same engine the public /intake uses, but with full 3-year normalization.' },
      ...
      { title: 'Comparable transactions tab', desc: '10 closest comps from the 100+ practice-sale set with revenue, SDE, multiple, sale year — defensible math, in 30 seconds.' },
    ],
