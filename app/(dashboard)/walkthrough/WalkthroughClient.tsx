...
const STEPS = [
  {
    ...
    what: 'Single screen with every number that matters: applicants this week, qualified pipeline, weighted EBITDA in motion, conversion funnel from intake → LOI → close, and the live platform-EBITDA tracker showing Wagner\'s $25M base + acquired ChiroPillar EBITDA toward the $45M+ combined-platform target.',
    features: [
      ...
      { title: 'Platform-EBITDA build-up bar', desc: 'Stacked horizontal: Wagner $25M base (blue) + ChiroPillar pipeline (gold) + remaining-to-$45M-target marker. Implied 9× exit shown alongside.' },
    ],
